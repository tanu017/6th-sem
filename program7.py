...
predicted_outcomes = knn.predict(user_input)
if predicted_outcomes[0] == 1:
    print("Based on the exam scores, the student is predicted to pass.")
else:
    print("Based on the exam scores, the student is predicted to fail.")